...
typedef enum {
	...
	CARD_CMD25_WRITE_MULTIPLE_BLOCK,   /* diag-only: eMMC snapshot writer */
#endif
	CARD_CMDMAX
} CARD_Cmd_e;
...
#ifdef CONFIG_SPL_EMMC_TRACE
	{CARD_CMD25_WRITE_MULTIPLE_BLOCK,25	,SIG_TRANS_CMP	| CARD_SDIO_R1		|ERR_DATA_END | ERR_DATA_CRC | ERR_DATA_TIMEOUT	,TRANS_MODE_MULTI_BLOCK | TRANS_MODE_BLOCK_COUNT_EN | TRANS_MODE_DMA_EN | CMD_HAVE_DATA},   /* write: TRANS_MODE_READ omitted = direction write */
#endif
