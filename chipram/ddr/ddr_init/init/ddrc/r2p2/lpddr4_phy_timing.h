...
/*************************************LP4 DMC PHY DTMG**********************************************/
/*-------------------1866--------------------*/
#define	DMC_PHY_LP4_1866_DTMG0		0x1800003E    			/*0x40,CFG0_TMG*/
#define	DMC_PHY_LP4_1866_DTMG1		0x00007FFF			/*0x44,CFG1_TMG*/
#if LP4X_ODT_EN(7)
#define DMC_PHY_LP4_1866_DTMG2		0x0000FFFE			/*0x48,CFG2_TMG*/
#else
...
/*-------------------1536--------------------*/
#define DMC_PHY_LP4_1536_DTMG0		0x1800003e
#define DMC_PHY_LP4_1536_DTMG1		0x00001fff
#if LP4X_ODT_EN(6)
#define DMC_PHY_LP4_1536_DTMG2		0x00003FFE
#else
...
/*LPDDR4X*/
#if LP4X_ODT_EN(6)
#define DMC_PHY_LP4_1536_DTMG5_LP4X	0x80400010
#else
#define DMC_PHY_LP4_1536_DTMG5_LP4X	0x80400010
#endif
/*LPDDR4*/
...
#define DMC_PHY_LP4_1536_DTMG5_LP4	0x80400060
#endif
#define DMC_PHY_LP4_1536_DTMG6		0x01100100
...
#if LP4X_ODT_EN(5)
#define DMC_PHY_LP4_1333_DTMG2		0x00003FFE
#else
...
#if LP4X_ODT_EN(5)
#define DMC_PHY_LP4_1333_DTMG5_LP4X	0x80400010
#else
#define DMC_PHY_LP4_1333_DTMG5_LP4X	0x80400010
#endif
/*LPDDR4*/
#if LP4_ODT_EN(5)
#define DMC_PHY_LP4_1333_DTMG5_LP4	0x80400010
#else
#define DMC_PHY_LP4_1333_DTMG5_LP4	0x80400010
#endif
#define DMC_PHY_LP4_1333_DTMG6		0x01100080
...
/*-------------------1024--------------------*/
#define DMC_PHY_LP4_1024_DTMG0		0x1800003E
#define DMC_PHY_LP4_1024_DTMG1		0x000007FF
#if LP4X_ODT_EN(4)
#define DMC_PHY_LP4_1024_DTMG2		0x00000FFE
#else
...
/*LPDDR4X*/
#if LP4X_ODT_EN(4)
#define DMC_PHY_LP4_1024_DTMG5_LP4X	0x80400004
#else
#define DMC_PHY_LP4_1024_DTMG5_LP4X	0x80400004
#endif
/*LPDDR4*/
#if LP4_ODT_EN(4)
#define DMC_PHY_LP4_1024_DTMG5_LP4	0x80400004
#else
#define DMC_PHY_LP4_1024_DTMG5_LP4	0x80400004
#endif

#define DMC_PHY_LP4_1024_DTMG6		0x01100040
#define DMC_PHY_LP4_1024_DTMG7		0x000a0fff
